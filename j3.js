...
Step 1. create a variable to store the value of the <p> element with the ID of "quote1"
...
var unit = document.getElementById('quote1');

unit.classList.add('animate__animated', 'animate__backInRight', 'animate__slower');
